...
console.log('Memory index.js loded')
const cards = [
...
const cardsHTML = memoryGame.cards.map(
  ...
  */
    ...
    insideDivFront.style = `background: url(img/${card.img}) no-repeat` // same as HTML inline <div style = ...></div>
...
// ------ attaching listeners to all cards
